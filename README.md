...
<p align="center">
<img src="https://www.google.com/search?q=https://img.shields.io/badge/Cloudflare-Workers-F38020%3Fstyle%3Dfor-the-badge%26logo%3Dcloudflare-workers%26logoColor%3Dwhite" alt="Cloudflare Workers">
...
Create a new inbox. Returns address and secret.

/api/messages

GET

Fetch emails. Requires address and secret params.
...
Tạo hộp thư mới. Trả về address và secret.

/api/messages

GET

Lấy danh sách email. Cần tham số address và secret.
